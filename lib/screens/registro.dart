    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // Contenedor Central (Diseño estético de la rama main)
          Center(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Botón Conductor con ruta funcional
                    _buildRoleButton(
                      context: context,
                      label: 'Soy conductor',
                      onPressed: () =>
                    ...
                    // Botón Pasajero con ruta funcional
                    _buildRoleButton(
                      context: context,
                      label: 'Soy pasajero',
                      onPressed: () =>
  ...
  Widget _buildFooter(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        GestureDetector(
          // Ruta funcional hacia iniciar_sesion
