...
class _EstimacionViajeState extends State<EstimacionViaje> with TickerProviderStateMixin {
  ...
  TextStyle mBold({Color color = primaryBlue, double size = 14, required double sw}) {
                ...
                child: ScaleTransition(
                  ...
                  child: Image.asset(
                    ...
                    errorBuilder: (c, e, s) => CircleAvatar(
                      ...
                      radius: sp(30, sw),
                      child: Icon(_isVoiceActive ? Icons.graphic_eq : Icons.mic,
                          color: Colors.white, size: sp(28, sw)),
                    ),
                  ),
                ),
              ),
  ...
  Widget _buildInfoCard(double sw, double sh) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Center(child: Text('Detalles del viaje', style: mBold(size: 18, sw: sw))),
          SizedBox(height: sp(20, sw)),
          _buildLocationRow(Icons.location_on, 'Desde', 'Punto de partida', sw),
          SizedBox(height: sp(15, sw)),
          _buildLocationRow(Icons.location_on, 'Destino', 'Punto de llegada', sw),
      ...
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(title, style: mBold(size: 10, color: accentBlue, sw: sw)),
              Text(subtitle,
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: GoogleFonts.montserrat(
                      fontSize: sp(13, sw), fontWeight: FontWeight.w600)),
            ],
          ),
        ),
      ],
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: sp(12, sw)),
          Text(text, style: mBold(size: 13, color: Colors.black87, sw: sw)),
        ],
      ),
    );
  }
  ...
  Widget _buildConfirmButton(double sw) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child:
            Text('Confirmar', style: mBold(color: Colors.white, size: 17, sw: sw)),
      ),
    );
  }
  ...
  Widget _navIcon(int index, IconData icon, double sw) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon, color: active ? Colors.white : primaryBlue,
            size: sp(26, sw)),
      ),
    );
  }
